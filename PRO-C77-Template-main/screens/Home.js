        ...
        return (
            <SafeAreaView style={styles.container}>
                <ImageBackground source={require('../assets/stars.gif')} style={styles.backgroundImage}>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={() => navigation.navigate("SpaceCraft")}>
                        <Text style={styles.routeText}>Spacecrafts</Text>
                        <Image source={require("../assets/space_crafts.png")} style={styles.routeImage} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.routeCard} onPress={() => navigation.navigate("StarMap")}>
                        <Text style={styles.routeText}>Star Map</Text>
                        <Image source={require("../assets/star_map.png")} style={styles.routeImage} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.routeCard} onPress={() => navigation.navigate("DailyPic")}>
